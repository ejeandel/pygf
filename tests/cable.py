...
for i in range(0,2):
    ...
    layer.polyline([p(0,0+x), p(1,0+x)    ,p(2, 0.35+x), p(2, 0.45+x), p(1,0.1+x), p(0, 0.1+x)], closed=True, fill="Brown",thickness=2)
    A,B,C,D,E,F = p(0,0.2+x), p(1,0.2+x),p(2, 0.45+x), p(2, 0.55+x), p(1,0.3+x), p(0, 0.3+x)
    ...
    layer123.polyline([p(0,0.4+x), p(1,0.4+x),p(2, 0.55+x), p(2, 0.65+x), p(1,0.5+x), p(0, 0.5+x)], closed=True, fill="Green",thickness=2)
    layer4.polyline([p(0,0.4+x), p(1,0.4+x),p(2, 0.55+x), p(2, 0.65+x), p(1,0.5+x), p(0, 0.5+x)], closed=True, fill="Green" if i == 0 else "Orange",thickness=2)
    
    A,B,C,D,E,F = p(0,0.6+x), p(1,0.6+x),p(2, 0.65+x), p(2, 0.75+x), p(1,0.7+x), p(0, 0.7+x)    
    layer.polyline([A,B,C,D,E,F], closed=True,thickness=2)
    ...
    layer.polyline([p(0,0.8+x), p(1,0.8+x),p(2, 0.75+x), p(2, 0.85+x), p(1,0.9+x), p(0, 0.9+x)], closed=True, fill="Blue",thickness=2)
    A,B,C,D,E,F = p(0,1+x), p(1,1+x)    ,p(2, 0.85+x), p(2, 0.95+x), p(1,1.1+x), p(0, 1.1+x)
    layer.polyline([A,B,C,D,E,F], closed=True,thickness=2)
    ...
    layer4.polyline([A, 0.5*(A+B), 0.5*(E+F), F], closed=True, draw=None, fill="Green" if i == 0 else "Orange")    
    layer4.polyline([B, 0.5*(B+C), 0.5*(D+E), E], closed=True, draw=None, fill="Green" if i == 0 else "Orange")

    layer123.polyline([p(0,1.2+x), p(1,1.2+x),p(2, 0.95+x), p(2, 1.05+x), p(1,1.3+x), p(0, 1.3+x)], closed=True, fill="Orange",thickness=2)
    layer4.polyline([p(0,1.2+x), p(1,1.2+x),p(2, 0.95+x), p(2, 1.05+x), p(1,1.3+x), p(0, 1.3+x)], closed=True, fill="Orange" if i == 0 else "Green",thickness=2)
    A,B,C,D,E,F = p(0,1.4+x), p(1,1.4+x),p(2, 1.05+x), p(2, 1.15+x), p(1,1.5+x), p(0, 1.5+x)
    layer.polyline([A,B,C,D,E,F], closed=True,thickness=2)
    ...
    layer4.polyline([A, 0.5*(A+B), 0.5*(E+F), F], closed=True, draw=None, fill="Orange" if i == 0 else "Green")    
    layer4.polyline([B, 0.5*(B+C), 0.5*(D+E), E], closed=True, draw=None, fill="Orange" if i == 0 else "Green")



    layer.polyline([p(2, 1.4+x), p(2,0.1+x)])
    layer.edge([p(2, 1.4+x)@{'angle':0}, p(3, 1.2+x)@{'angle':0}, p(4,1.2+x)@{'angle':0}, p(4,0.3+x)@{'angle':180}, p(3,0.3+x)@{'angle':180}, p(2, 0.1+x)@{'angle':180}], fill=color)
...
layer.edge([p(3, 1.2)@{'angle':0}, p(8,1.2)@{'angle':0}, p(13,-1.25)@{'angle':-90}, p(8,-3.7)@{'angle':180}, p(3, -3.7)@{'angle':180},
            p(3, -2.8)@{'angle':0}, p(8,-2.8)@{'angle':0}, p(12,-1.25)@{'angle':90}, p(8, 0.3)@{'angle':180}, p(3,0.3)@{'angle':180}, p(3,1.2)@{'angle':0}
            ], draw=None, fill=color)


layer.edge([p(3, 1.2)@{'angle':0}, p(8,1.2)@{'angle':0}, p(13,-1.25)@{'angle':-90}, p(8,-3.7)@{'angle':180}, p(3, -3.7)@{'angle':180}])
layer.edge([p(3, -2.8)@{'angle':0}, p(8,-2.8)@{'angle':0}, p(12,-1.25)@{'angle':90}, p(8, 0.3)@{'angle':180}, p(3,0.3)@{'angle':180}])
